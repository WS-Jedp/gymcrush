      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        >
          <motion.h2
            ...
            className="text-4xl md:text-6xl font-bold leading-tight mb-8 overflow-hidden"
          >
            <motion.span
...
export const RomanticWhyYouSlide: React.FC<RomanticSlideProps> = ({ slide }) => {
  ...
  const blurTransform = useTransform(scrollYProgress, [0.2, 0.4, 0.8], ["blur(2px)", "blur(0px)", "blur(0px)"]);
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {slide.points.map((fact, index) => (
              <motion.div
                ...
                className="premium-card backdrop-blur-lg bg-white/80 p-6 rounded-2xl border border-royal-gold/20 shadow-lg group cursor-pointer"
            ...
            <div className="horizontal-scroll horizontal-scroll-snap flex space-x-6 overflow-x-auto pb-4">
              {slide.questions.map((question, index) => (
                <motion.div
                  ...
                  className="horizontal-scroll-item premium-card-dark min-w-80 max-w-80 p-6 md:p-8 flex-shrink-0 cursor-pointer"
                ...
                >
                  <div className="h-full flex flex-col justify-between">
                    <div>
                      ...
                      <p className="text-lg text-pearl-white leading-relaxed font-serif">
                        {question}
                      </p>
                    </div>
